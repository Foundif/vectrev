    ...
    <section className="px-5 sm:px-8 py-10">
      <div className="max-w-7xl mx-auto rounded-[2rem] bg-dark text-dark-foreground p-8 md:p-12 grid lg:grid-cols-12 gap-8 items-center">
        <div className="lg:col-span-8">
          <div className="text-xs uppercase tracking-[0.22em] text-white/50">Company profile 2025</div>
          ...
          <p className="mt-4 text-white/70 max-w-2xl leading-relaxed">
            Capability statement, instrument fleet, completed projects across India and Cameroon,
            and our 2025-26 plans — ready for vendor empanelment and tender submissions.
          </p>
        </div>
